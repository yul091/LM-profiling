...
from utils import ActiveSelectionTrainer, ActiveSelectionBertForSequenceClassification
...
class DataTrainingArguments:
    ...
    minibatch: int = field(
        default=None,
        metadata={"help": "The number of samples to be selected in each iteration."},
    )
    strategy: str = field(
        default=None,
